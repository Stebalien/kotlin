...
fun PsiElement.toLightMethods(): List<PsiMethod> =
        when (this) {
            ...
            is JetProperty -> LightClassUtil.getLightClassPropertyMethods(this).iterator().toArrayList()
            is JetParameter -> LightClassUtil.getLightClassPropertyMethods(this).iterator().toArrayList()
