...
public class ByteProgression(
    ...
    fun equals(o: Any?): Boolean {
        val that = o as? ByteProgression ?: return false
        return start == that.start && end == that.end && increment == that.increment
    }
...
public class CharProgression(
    ...
    fun equals(o: Any?): Boolean {
        val that = o as? CharProgression ?: return false
        return start == that.start && end == that.end && increment == that.increment
    }
...
public class ShortProgression(
    ...
    fun equals(o: Any?): Boolean {
        val that = o as? ShortProgression ?: return false
        return start == that.start && end == that.end && increment == that.increment
    }
...
public class IntProgression(
    ...
    fun equals(o: Any?): Boolean {
        val that = o as? IntProgression ?: return false
        return start == that.start && end == that.end && increment == that.increment
    }
...
public class LongProgression(
    ...
    fun equals(o: Any?): Boolean {
        val that = o as? LongProgression ?: return false
        return start == that.start && end == that.end && increment == that.increment
    }
...
public class FloatProgression(
    ...
    fun equals(o: Any?): Boolean {
        val that = o as? FloatProgression ?: return false
        return java.lang.Float.compare(start, that.start) == 0 && java.lang.Float.compare(end, that.end) == 0 && java.lang.Float.compare(increment, that.increment) == 0
    }
...
public class DoubleProgression(
    ...
    fun equals(o: Any?): Boolean {
        val that = o as? DoubleProgression ?: return false
        return java.lang.Double.compare(start, that.start) == 0 && java.lang.Double.compare(end, that.end) == 0 && java.lang.Double.compare(increment, that.increment) == 0
    }
